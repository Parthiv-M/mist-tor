...
const Proposal = () => {
   return (
       <div><div class="mainCard  rounded-none sm:rounded-lg max-w-3xl">
        <div class="closeBtn px-2 py-2 sm:px-3 sm:py-4">
            ...
            <div class="px-10 py-9 sm:px-15 sm:py-0">
                ...
                <div class="grid-rows-1">
                 <textarea class="Box px-3" type="text" rows="5" cols="50" placeholder="Write your Proposal here..."></textarea>
                </div>
               
                <div class="px-5 py-3 sm:px-0 sm:py-0">
                    <button class="btn-upload text-white py-1 px-1 text-l mr-4">
                ...
                <div class="px-10 py-6 sm:px-8 sm:py-0">
                    <span class="upload">Related files (if any)</span>
                </div> 
                <div  class="grid-rows-1">
                 <button class="btn-propose text-white font-weight:900 py-2 px-6 text-l mr-4">Post</button>
            </div>
